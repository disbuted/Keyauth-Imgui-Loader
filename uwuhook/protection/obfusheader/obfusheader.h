...
#define NORMAL      1 // originally 0 but oh well
...
#define INDIRECT_BRANCHING          0 // this breaks with xorstr so be careful when using this :(
#define FAKE_SIGNATURES             1
#define INLINE_STD                  1
#define KERNEL_MODE                 1 // Disables some features that are not compatible with kernel mode (like fake signatures)
